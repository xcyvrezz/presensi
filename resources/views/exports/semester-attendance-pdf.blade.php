...
<body>
    ...
    <div class="highlight-box">
        <p><strong>Catatan Penting:</strong> Rekap semester ini menghitung hari efektif sekolah dengan mengecualikan Sabtu, Minggu, dan event kalender yang ditandai sebagai libur (`is_holiday = true`). Event non-libur seperti UAS atau kegiatan sekolah tetap dihitung. Persentase kehadiran dihitung berdasarkan: <strong>Persentase = (Total Kehadiran / Hari Efektif) × 100%</strong></p>
    </div>
    ...
    <div class="footer">
        ...
        <p style="margin-top: 5px;">&copy; {{ $semester->academic_year }} - Semua data bersifat rahasia dan hanya untuk keperluan administrasi sekolah</p>
    </div>
</body>
</html>
