    ...
    <div class="mb-6">
        <div class="flex items-center mb-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Perbarui informasi kelas dan wali kelas</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-700">
                    Kelas ini saat ini memiliki <strong>{{ $class->current_students }} siswa</strong>.
                    Kapasitas tidak boleh kurang dari jumlah siswa yang ada.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" wire:model="capacity" min="{{ $class->current_students }}" max="50" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('capacity') border-red-500 @enderror">
                        @error('capacity') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                        <p class="mt-1 text-xs text-gray-500">Minimal {{ $class->current_students }} siswa (saat ini), maksimal 50</p>
                    </div>
